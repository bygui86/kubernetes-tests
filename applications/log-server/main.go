...
import (
	...
	"github.com/bygui86/kubernetes-tests/applications/log-server/kubernetes"
	"github.com/bygui86/kubernetes-tests/applications/log-server/rest"
...
func main() {
	...
	logger.Log.Infoln("[MAIN] Starting log-server...")
	...
	logger.Log.Infoln("[MAIN] log-server ready!")
